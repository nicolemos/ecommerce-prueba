...
--
-- Host: localhost    Database: technolearn
-- ------------------------------------------------------
...
CREATE TABLE `cursos_usuarios` (
  ...
  `progreso_usuario` int DEFAULT NULL,
  KEY `FK_USUARIOS` (`id_usuario`),
  KEY `FK_CURSOS` (`id_curso`),
  CONSTRAINT `FK_CURSOS` FOREIGN KEY (`id_curso`) REFERENCES `cursos` (`id_cursos`),
...
-- Dump completed on 2023-02-04 21:56:53
